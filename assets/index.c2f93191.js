...
WS               ::= [#x20#x09#x0A#x0D]+
`;var Q=(c,o)=>{const p=c.__vccOpts||c;for(const[u,t]of o)p[u]=t;return p};const C=c=>(H("data-v-a87dc856"),c=c(),b(),c),X=C(()=>a("h3",null,"Original formula:",-1)),Y=C(()=>a("option",{value:","},[_("Use "),a("code",null,","),_(" as argument separator")],-1)),j=C(()=>a("option",{value:";"},[_("Use "),a("code",null,";"),_(" as argument separator")],-1)),q=[Y,j],z=C(()=>a("h3",null,"Transformed formula:",-1)),Z={class:"result"},J={class:"unparsed"},ee=w({setup(c){const o=v("");console.log(L);let p;function u(e,r){if(e.type===r)return e;if(e.children.length===1)return u(e.children[0],r);throw new Error(`Expected ${r} got ${e.type}: ${e.text}`)}function t(e){return parseFloat(u(e,"Number").text)}function s(e){return u(e,"Boolean").text.toUpperCase()==="TRUE"}function d(e,r){return r(e,n=>{let l=n.text;const i=n.start;return n.children.slice().reverse().forEach(m=>{l=l.slice(0,m.start-i)+d(m,r)+l.slice(m.end-i)}),l})}function P(e){let r=1,n="";for(let l=e.length-1;l>=0;l--){let i=e.toUpperCase().charCodeAt(l);if(i+=r,i>90?(i=65,r=1):r=0,n=String.fromCharCode(i)+n,!r){n=e.substring(0,l)+n;break}}return r&&(n="A"+n),n}function N(e,r){return d(e,(n,l)=>{if(n.type==="Range"){const i=n.children[0],m=n.children[1];let E="UNKNOWN";const x=d(i,(f,R)=>{if(f.type==="ColumnAddress"){E=f.text;for(let y=0;y<r;y++)E=P(E);return E}else return R(f)}),S=d(m,(f,R)=>f.type==="ColumnAddress"?E:R(f));return`${x}:${S}`}return l(n)})}function $(e,r){if(e.type=="FunctionCall"&&e.children[0].text.toUpperCase()==="VLOOKUP"&&e.children[1].children.length>=3&&e.children[1].children.length<=4){const n=e.children[1].children;console.log("Found VLOOKUP",n);const l=n[0],i=u(n[1],"Reference"),m=t(n[2]),E=n.length===3?!0:n[3].type=="EmptyArgument"?!1:s(n[3]),x=N(i,0),S=N(i,m-1),f=E?"":`${o.value} 0`,R=r(l);return`INDEX(${S}${o.value} MATCH(${R}${o.value} ${x}${f}))`}else return r(e)}const h=v(""),A=v(""),g=v("");return I(o,e=>{const r=T.Grammars.Custom.getRules(L).concat(T.Grammars.Custom.getRules(`
ARGUMENT_SEPARATOR ::= "${e}"
`));console.log(r),p=new T.Parser(r,{}),h.value=`=VLOOKUP(F2${e}tech!B:F${e}5${e}FALSE)`}),I(h,e=>{console.log(e);const r=p.getAST(e);if(console.log(r),r===null)A.value="Failed to parse: ",g.value=e;else try{A.value=d(r,$),g.value=r.rest}catch(n){console.error(n),A.value="Failed to transform: ",g.value=n}console.log("Transformed:",A.value)}),o.value=";",(e,r)=>(F(),W(V,null,[X,O(a("textarea",{class:"input","onUpdate:modelValue":r[0]||(r[0]=n=>h.value=n)},null,512),[[D,h.value]]),a("div",null,[O(a("select",{"onUpdate:modelValue":r[1]||(r[1]=n=>o.value=n)},q,512),[[M,o.value]])]),z,a("div",Z,[_(U(A.value),1),a("span",J,U(g.value),1)])],64))}});var ne=Q(ee,[["__scopeId","data-v-a87dc856"]]);const re=B("<h1>Transform VLOOKUP to INDEX/MATCH!</h1><p> The <code>VLOOKUP</code> formula in Excel and Google Sheets is inefficient, and is prone to break when the target range is restructured. The solution is to use <code>INDEX</code> and <code>MATCH</code>! However, transforming existing formulae is non-trivial and easy to mess up. </p><p> Hence this conveter tool! Take your existing formula, pop it into the box below, and it will convert all your existing <code>VLOOKUP</code> calls to <code>INDEX-MATCH</code>! </p>",3),te=w({setup(c){return(o,p)=>(F(),W("main",null,[re,G(ne)]))}});k(te).mount("#app");
